        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" >
          ...
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title">Change Starting Date</h3>
            </div>
            <div class="panel-body">
                ...
                <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-user-information">
                    ...
                    <tbody>
                        <tr>
                            <td>Previous: </td>
                            <td><input type="text" value="<?php echo $date_started?>" class="form-control" readonly=""</td>
                        </tr>
                      <tr>
                        <td>Date Started:</td>
              ...
              <?php
                 if (isset($_POST['change'])) {
                     $u_date_started = $_POST['date_started'];
                     $conn = oci_connect(ORA_CON_UN, ORA_CON_PW, ORA_CON_DB);
                     $s = oci_parse($conn, "UPDATE TENANTS SET DUE_DATE=TO_DATE('".$u_date_started."', 'yyyy/mm/dd') WHERE T_ID='".$token."'");
                     $r = oci_execute($s);
                     if ($r) {
